...
$(document).ready(function(){
	...
	// Castro/Upper Market
	// $('.castro-btn').mouseenter(function(){
	// 	highlightCastro();
	// });
	// $('.castro-btn').mouseleave(function(){
	// 	clearMap();
	// });

	// // SOMA
	// $('.soma-btn').mouseenter(function(){
	// 	highlightSOMA();
	// });
	// $('.soma-btn').mouseleave(function(){
	// 	clearMap();
	// });

	// // Russian Hill
	// $('.russian-hill-btn').mouseenter(function(){
	// 	highlightRH();
	// });
	// $('.russian-hill-btn').mouseleave(function(){
	// 	clearMap();
	// });
