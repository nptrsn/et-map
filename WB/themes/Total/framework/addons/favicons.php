	...
	class WPEX_Favicons {
		...
		public function output_favicons() {
			...
			if ( $icon = get_theme_mod( 'iphone_icon' ) ) {
				$output .= '<link rel="apple-touch-icon-precomposed" href="'. esc_url( $icon ) .'">';
			}

			// Apple iPad Icon - 76px
			if ( $icon = get_theme_mod( 'ipad_icon' ) ) {
				$output .= '<link rel="apple-touch-icon-precomposed" sizes="76x76" href="'. esc_url( $icon ) .'">';
			}

			// Apple iPhone Retina Icon - 120px
			if ( $icon = get_theme_mod( 'iphone_icon_retina' ) ) {
				$output .= '<link rel="apple-touch-icon-precomposed" sizes="120x120" href="'. esc_url( $icon ) .'">';
			}

			// Apple iPad Retina Icon - 114px
			if ( $icon = get_theme_mod( 'ipad_icon_retina' ) ) {
				$output .= '<link rel="apple-touch-icon-precomposed" sizes="114x114" href="'. esc_url( $icon ) .'">';
			}
