...
function wpex_display_breadcrumbs() {
	...
	// Built-in breadcrumbs
		...
		echo wpex_breadcrumbs( $wpex_theme->post_id );
	}
	...
	function wpex_breadcrumbs( $post_id = '' ) {
		...
		elseif ( is_singular() ) {
			...
			if ( 'post' == $post_type ) {
				...
				// Categories
				if ( get_theme_mod( 'breadcrumbs_blog_cat', true ) && $terms = wpex_list_post_terms( $taxonomy = 'category', $show_links = true, $echo = false ) ) {
